                         ...
                         try {
                             ...
                             historyList.forEach(entry => {
                                 ...
                                 row.innerHTML = `
                                     ...
                                     <div class="history-symbol">${entry.symbol || ''}</div>
                                     <div class="history-value">${formatNum(entry.bybitPrice)}</div>
                                     <div class="history-value">${formatNum(entry.kucoinPrice)}</div>
                                 `;
